...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AsesorDocente_id" DataSourceID="SqlDataSourceDocentes" EnableModelValidation="True">
        <Columns>
            ...
            <asp:BoundField DataField="usuario_creacion" HeaderText="usuario_creacion" SortExpression="usuario_creacion"></asp:BoundField>
            <asp:BoundField DataField="fecha_actualizo" HeaderText="fecha_actualizo" SortExpression="fecha_actualizo"></asp:BoundField>
            <asp:BoundField DataField="usuario_actualizo" HeaderText="usuario_actualizo" SortExpression="usuario_actualizo"></asp:BoundField>
