            ...
            <form role="form" method="post" runat="server" class="form-horizontal">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="StudentNumber" DataSourceID="SqlDataSourceAplicar" CssClass="table table-bordered">
                    <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="Ver Evaluacion" DataTextField="StudentNumber" DataNavigateUrlFields="StudentNumber" DataNavigateUrlFormatString="~/ResultadoEvaluaciones.aspx?StudentNumber=StudentNumber" Text="ir" />
                    </Columns>
                </asp:GridView>
