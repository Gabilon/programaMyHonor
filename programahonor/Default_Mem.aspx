<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Membre.Master" CodeBehind="Default_Mem.aspx.vb" Inherits="programahonor.Default_Mem" %>
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p>
                                <a href="infoGeneral_Mem.aspx" class="btn btn-primary" role="button">Ver más</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p>
                                <a href="comitesEstu_Mem.aspx" class="btn btn-primary" role="button">Ver más</a>
                            </p>
                        </div>
                    </div>
                </div>
